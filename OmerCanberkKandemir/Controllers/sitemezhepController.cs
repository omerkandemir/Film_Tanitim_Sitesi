...
{
    public class sitemezhepController : Controller
    {
        ...
        // GET: sitemezhep/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: sitemezhep/Create
