...
namespace OmerCanberkKandemir.Controllers
{
    public class KullaniciController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "KullaniciID,kullaniciadi,Eposta,Sifre")] Kullanici kullanici)
        {
        ...
        {
            var login = db.Kullanici.Where(x => x.kullaniciadi == kullanici.kullaniciadi).SingleOrDefault();
            ViewBag.Uyari = "Kullanıcı adı veya şifre yanlış";
            if (login.kullaniciadi == kullanici.kullaniciadi && login.Sifre==kullanici.Sifre)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "KullaniciID,kullaniciadi,Eposta,Sifre")] Kullanici kullanici)
        {
            if (ModelState.IsValid)
            {
